package com.xuan.lovean.anhttp;
...
import com.xuan.lovean.anhttp.helper.AjaxCallBack;
import com.xuan.lovean.anhttp.helper.AjaxParams;
import com.xuan.lovean.anhttp.helper.HttpHandler;
import com.xuan.lovean.anhttp.helper.RetryHandler;
import com.xuan.lovean.anhttp.helper.SyncRequestHandler;

/**
 * Http请求的封装，支持图片断点传输等哦
 * 
 * @author xuan
 * @version $Revision: 1.0 $, $Date: 2013-4-7 下午3:06:05 $
 */
public class AnHttp {
	...
	private static final ThreadFactory sThreadFactory = new ThreadFactory() {
		...
		public Thread newThread(Runnable r) {
			Thread tread = new Thread(r, "AnHttp #" + mCount.getAndIncrement());
	...
	public HttpHandler<File> download(String url, AjaxParams params,
		...
		// TODO:handler.executeOnExecutor(executor, get, target, isResume);
		return handler;
	}
	...
	protected <T> void sendRequest(DefaultHttpClient client,
		...
		// TODO:new HttpHandler<T>(client, httpContext, ajaxCallBack, charset)
