...
public class StartAppUtils {
	 ...
	 * @param paramsMap
	 */
	public static void startApp4LaunchIntent(Context context, String pkg,
	 ...
	 * @param paramsMap
	 */
	public static void startApp4ComponentName(Context context, String pkg,
			String activity, HashMap<String, String> paramsMap) {
		try {
	 ...
	 * @param paramsMap
	 */
	public static void startApp4Url(final Context context, String url,
			HashMap<String, String> paramsMap) {
		try {
	 ...
	 * @param paramsMap
	 */
	public static void startApp4Category(final Context context,
			String intentStr, String categoryStr,
			HashMap<String, String> paramsMap) {
		try {
