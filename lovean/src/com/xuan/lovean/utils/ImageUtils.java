...
public abstract class ImageUtils {
	 ...
	 * @throws IOException
	 */
	public static void changeOppositeSize(InputStream src, String dest,
	 ...
	 * @return
	 */
	public static Drawable getUnreadedDrawable(Drawable baseDrawable,
			Resources resources, int unreadedNum) {
		Bitmap bitmap = Bitmap
				.createBitmap(
						baseDrawable.getIntrinsicWidth(),
						baseDrawable.getIntrinsicHeight(),
						baseDrawable.getOpacity() != PixelFormat.OPAQUE ? Bitmap.Config.ARGB_8888
								: Bitmap.Config.RGB_565);

		Canvas canvas = new Canvas(bitmap);
		baseDrawable.setBounds(0, 0, baseDrawable.getIntrinsicWidth(),
				baseDrawable.getIntrinsicHeight());
		baseDrawable.draw(canvas);

		Bitmap newBitmap = BitmapFactory.decodeResource(resources,
				R.drawable.msg_new);
	 ...
	 * @return
	 */
	public static Bitmap getUnreadedBitmap(Bitmap bitmap, Resources resources,
			int unreadedNum) {
		BitmapDrawable bitmapDrawable = new BitmapDrawable(resources, bitmap);
		BitmapDrawable ret = (BitmapDrawable) getUnreadedDrawable(
				bitmapDrawable, resources, unreadedNum);
