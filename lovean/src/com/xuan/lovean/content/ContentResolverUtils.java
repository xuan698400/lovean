package com.xuan.lovean.content;
...
public abstract class ContentResolverUtils {
	...
	public static final Cursor query(Context context, Uri uri,
			...
			String sortOrder) {
		return getContentResolver(context).query(uri, projection, selection,
	...
	public static final int update(Context context, Uri uri,
		...
		return getContentResolver(context).update(uri, values, where,
				selectionArgs);
	}
