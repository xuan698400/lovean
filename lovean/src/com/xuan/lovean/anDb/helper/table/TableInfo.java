...
import com.xuan.lovean.anDb.helper.reflect.ClassUtils;
import com.xuan.lovean.anDb.helper.reflect.FieldUtils;

/**
 * 数据库表的封装
 * 
 * @author xuan
 * @version $Revision: 1.0 $, $Date: 2013-4-8 上午9:38:39 $
 */
public class TableInfo {
    ...
    public static TableInfo get(Class<?> clazz) {
        if (clazz == null) {
            throw new AnDbException("table info get error,because the clazz is null");
        }
        ...
        if (tableInfo == null) {
            ...
            if (idField != null) {
                ...
                throw new AnDbException("the class[" + clazz + "]'s idField is null");
            }
