...
import com.xuan.lovean.anDb.helper.annotation.Table;
 ...
 * 
 * @author xuan
 * @version $Revision: 1.0 $, $Date: 2013-4-8 上午9:52:35 $
 */
            ...
            for (Field f : fs) {
                if (!FieldUtils.isTransient(f) && FieldUtils.isOneToMany(f)) {
                    ...
                    if (type instanceof ParameterizedType) {
                        ...
                        throw new AnDbException("getOneToManyList Exception:" + f.getName() + "'s type is null");
                    }
