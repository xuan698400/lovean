package com.xuan.lovean.anDb.helper.reflect;
...
import com.xuan.lovean.anDb.helper.annotation.Id;
import com.xuan.lovean.anDb.helper.annotation.ManyToOne;
import com.xuan.lovean.anDb.helper.annotation.OneToMany;
import com.xuan.lovean.anDb.helper.annotation.Property;
import com.xuan.lovean.anDb.helper.annotation.Transient;

/**
 * 操作字段的工具类
 * 
 * @author xuan
 * @version $Revision: 1.0 $, $Date: 2013-4-8 上午10:18:13 $
 */
public class FieldUtils {
    ...
    // 检查是否是is开头，并第三个字符大写，例如isAdmin因为这种命名的她妈他的is方法和set方法特别一点的
